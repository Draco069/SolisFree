--[[
-- Solis, a free and open-source Roblox script hub.
...
newInstance("Solis", "Folder", "Solis", nil)

newModule("App", "ModuleScript", "Solis.App", "Solis", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.App"))() end)

newInstance("components", "Folder", "Solis.components", "Solis")

newModule("Acrylic", "ModuleScript", "Solis.components.Acrylic", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Acrylic").default
return exports
 end, newEnv("Solis.components.Acrylic"))() end)

newModule("Acrylic", "ModuleScript", "Solis.components.Acrylic.Acrylic", "Solis.components.Acrylic", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.components.Acrylic.Acrylic"))() end)

newModule("Acrylic.story", "ModuleScript", "Solis.components.Acrylic.Acrylic.story", "Solis.components.Acrylic", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return function(target)
 ...
 end, newEnv("Solis.components.Acrylic.Acrylic.story"))() end)

newModule("acrylic-instance", "ModuleScript", "Solis.components.Acrylic.acrylic-instance", "Solis.components.Acrylic", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.components.Acrylic.acrylic-instance"))() end)

newModule("ActionButton", "ModuleScript", "Solis.components.ActionButton", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.components.ActionButton"))() end)

newModule("Border", "ModuleScript", "Solis.components.Border", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.components.Border"))() end)

newModule("BrightButton", "ModuleScript", "Solis.components.BrightButton", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
...
return {
 ...
 end, newEnv("Solis.components.BrightButton"))() end)

newModule("BrightSlider", "ModuleScript", "Solis.components.BrightSlider", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.components.BrightSlider"))() end)

newModule("Canvas", "ModuleScript", "Solis.components.Canvas", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
...
return {
 ...
 end, newEnv("Solis.components.Canvas"))() end)

newModule("Card", "ModuleScript", "Solis.components.Card", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Acrylic = TS.import(script, script.Parent, "Acrylic").default
...
return {
 ...
 end, newEnv("Solis.components.Card"))() end)

newModule("Fill", "ModuleScript", "Solis.components.Fill", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local mapBinding = TS.import(script, script.Parent.Parent, "utils", "binding-util").mapBinding
...
return {
 ...
 end, newEnv("Solis.components.Fill"))() end)

newModule("Glow", "ModuleScript", "Solis.components.Glow", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.components.Glow"))() end)

newModule("ParallaxImage", "ModuleScript", "Solis.components.ParallaxImage", "Solis.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local mapBinding = TS.import(script, script.Parent.Parent, "utils", "binding-util").mapBinding
local scale = TS.import(script, script.Parent.Parent, "utils", "udim2").scale
...
return {
 ...
 end, newEnv("Solis.components.ParallaxImage"))() end)

newModule("constants", "ModuleScript", "Solis.constants", "Solis", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
local SOLIS_LOADER_URL = "https://raw.githubusercontent.com/CHANGE_ME/Solis/main/public/latest.lua"
return {
	IS_DEV = IS_DEV,
	VERSION_TAG = VERSION_TAG,
	SOLIS_LOADER_URL = SOLIS_LOADER_URL,
}
 end, newEnv("Solis.constants"))() end)

newInstance("context", "Folder", "Solis.context", "Solis")

newModule("scale-context", "ModuleScript", "Solis.context.scale-context", "Solis.context", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.context.scale-context"))() end)

newInstance("hooks", "Folder", "Solis.hooks", "Solis")

newInstance("common", "Folder", "Solis.hooks.common", "Solis.hooks")

newModule("flipper-hooks", "ModuleScript", "Solis.hooks.common.flipper-hooks", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
...
return exports
 end, newEnv("Solis.hooks.common.flipper-hooks"))() end)

newModule("get-binding", "ModuleScript", "Solis.hooks.common.flipper-hooks.get-binding", "Solis.hooks.common.flipper-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.hooks.common.flipper-hooks.get-binding"))() end)

newModule("use-goal", "ModuleScript", "Solis.hooks.common.flipper-hooks.use-goal", "Solis.hooks.common.flipper-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.common.flipper-hooks.use-goal"))() end)

newModule("use-instant", "ModuleScript", "Solis.hooks.common.flipper-hooks.use-instant", "Solis.hooks.common.flipper-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.common.flipper-hooks.use-instant"))() end)

newModule("use-linear", "ModuleScript", "Solis.hooks.common.flipper-hooks.use-linear", "Solis.hooks.common.flipper-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.common.flipper-hooks.use-linear"))() end)

newModule("use-motor", "ModuleScript", "Solis.hooks.common.flipper-hooks.use-motor", "Solis.hooks.common.flipper-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.common.flipper-hooks.use-motor"))() end)

newModule("use-spring", "ModuleScript", "Solis.hooks.common.flipper-hooks.use-spring", "Solis.hooks.common.flipper-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Spring = TS.import(script, TS.getModule(script, "@rbxts", "flipper").src).Spring
local useGoal = TS.import(script, script.Parent, "use-goal").useGoal
...
return {
 ...
 end, newEnv("Solis.hooks.common.flipper-hooks.use-spring"))() end)

newModule("rodux-hooks", "ModuleScript", "Solis.hooks.common.rodux-hooks", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.common.rodux-hooks"))() end)

newModule("use-delayed-update", "ModuleScript", "Solis.hooks.common.use-delayed-update", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useEffect = _roact_hooked.useEffect
local useMutable = _roact_hooked.useMutable
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-delayed-update"))() end)

newModule("use-did-mount", "ModuleScript", "Solis.hooks.common.use-did-mount", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useEffect = _roact_hooked.useEffect
local useMutable = _roact_hooked.useMutable
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-did-mount"))() end)

newModule("use-forced-update", "ModuleScript", "Solis.hooks.common.use-forced-update", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useCallback = _roact_hooked.useCallback
local useState = _roact_hooked.useState
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-forced-update"))() end)

newModule("use-interval", "ModuleScript", "Solis.hooks.common.use-interval", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-interval"))() end)

newModule("use-mouse-location", "ModuleScript", "Solis.hooks.common.use-mouse-location", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useBinding = _roact_hooked.useBinding
local useEffect = _roact_hooked.useEffect
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-mouse-location"))() end)

newModule("use-promise", "ModuleScript", "Solis.hooks.common.use-promise", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useEffect = _roact_hooked.useEffect
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-promise"))() end)

newModule("use-rotation", "ModuleScript", "Solis.hooks.common.use-rotation", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useBinding = _roact_hooked.useBinding
local useEffect = _roact_hooked.useEffect
local RunService = TS.import(script, TS.getModule(script, "@rbxts", "services")).RunService
local function useRotation(degreesPerSecond)
	if degreesPerSecond == nil then
		degreesPerSecond = 90
	end
	local _binding = useBinding(0)
	local rotation = _binding[1]
	local setRotation = _binding[2]
	useEffect(function()
		local current = 0
		local handle = RunService.RenderStepped:Connect(function(deltaTime)
			current = (current + deltaTime * degreesPerSecond) % 360
			setRotation(current)
		end)
		return function()
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-rotation"))() end)

newModule("use-set-state", "ModuleScript", "Solis.hooks.common.use-set-state", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-set-state"))() end)

newModule("use-spring", "ModuleScript", "Solis.hooks.common.use-spring", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Spring = TS.import(script, TS.getModule(script, "@rbxts", "flipper").src).Spring
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-spring"))() end)

newModule("use-viewport-size", "ModuleScript", "Solis.hooks.common.use-viewport-size", "Solis.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useBinding = _roact_hooked.useBinding
local useEffect = _roact_hooked.useEffect
...
return {
 ...
 end, newEnv("Solis.hooks.common.use-viewport-size"))() end)

newModule("use-current-page", "ModuleScript", "Solis.hooks.use-current-page", "Solis.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.use-current-page"))() end)

newModule("use-friends", "ModuleScript", "Solis.hooks.use-friends", "Solis.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.hooks.use-friends"))() end)

newModule("use-parallax-offset", "ModuleScript", "Solis.hooks.use-parallax-offset", "Solis.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Spring = TS.import(script, TS.getModule(script, "@rbxts", "flipper").src).Spring
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.hooks.use-parallax-offset"))() end)

newModule("use-scale", "ModuleScript", "Solis.hooks.use-scale", "Solis.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.hooks.use-scale"))() end)

newModule("use-theme", "ModuleScript", "Solis.hooks.use-theme", "Solis.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local useAppSelector = TS.import(script, script.Parent, "common", "rodux-hooks").useAppSelector
...
return {
 ...
 end, newEnv("Solis.hooks.use-theme"))() end)

newModule("jobs", "ModuleScript", "Solis.jobs", "Solis", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.include.RuntimeLib)
local exports = {}
exports.setStore = TS.import(script, script, "helpers", "job-store").setStore
return exports
 end, newEnv("Solis.jobs"))() end)

newModule("acrylic", "LocalScript", "Solis.jobs.acrylic", "Solis.jobs", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Make = TS.import(script, TS.getModule(script, "@rbxts", "make"))
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.acrylic"))() end)

newInstance("character", "Folder", "Solis.jobs.character", "Solis.jobs")

newModule("flight", "LocalScript", "Solis.jobs.character.flight", "Solis.jobs.character", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _flipper = TS.import(script, TS.getModule(script, "@rbxts", "flipper").src)
local GroupMotor = _flipper.GroupMotor
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.character.flight"))() end)

newModule("ghost", "LocalScript", "Solis.jobs.character.ghost", "Solis.jobs.character", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _services = TS.import(script, TS.getModule(script, "@rbxts", "services"))
local Players = _services.Players
local Workspace = _services.Workspace
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.character.ghost"))() end)

newModule("godmode", "LocalScript", "Solis.jobs.character.godmode", "Solis.jobs.character", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _services = TS.import(script, TS.getModule(script, "@rbxts", "services"))
local Players = _services.Players
local Workspace = _services.Workspace
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.character.godmode"))() end)

newModule("humanoid", "LocalScript", "Solis.jobs.character.humanoid", "Solis.jobs.character", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
local _job_store = TS.import(script, script.Parent.Parent, "helpers", "job-store")
local getStore = _job_store.getStore
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.character.humanoid"))() end)

newModule("refresh", "LocalScript", "Solis.jobs.character.refresh", "Solis.jobs.character", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _services = TS.import(script, TS.getModule(script, "@rbxts", "services"))
local Players = _services.Players
local Workspace = _services.Workspace
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.character.refresh"))() end)

newModule("freecam", "LocalScript", "Solis.jobs.freecam", "Solis.jobs", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.freecam"))() end)

newInstance("helpers", "Folder", "Solis.jobs.helpers", "Solis.jobs")

newModule("freecam", "ModuleScript", "Solis.jobs.helpers.freecam", "Solis.jobs.helpers", function () return setfenv(function() ------------------------------------------------------------------------
-- Freecam
...
return {
 ...
 end, newEnv("Solis.jobs.helpers.freecam"))() end)

newModule("get-selected-player", "ModuleScript", "Solis.jobs.helpers.get-selected-player", "Solis.jobs.helpers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
return {
 ...
 end, newEnv("Solis.jobs.helpers.get-selected-player"))() end)

newModule("job-store", "ModuleScript", "Solis.jobs.helpers.job-store", "Solis.jobs.helpers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.jobs.helpers.job-store"))() end)

newInstance("players", "Folder", "Solis.jobs.players", "Solis.jobs")

newModule("hide", "LocalScript", "Solis.jobs.players.hide", "Solis.jobs.players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.players.hide"))() end)

newModule("kill", "LocalScript", "Solis.jobs.players.kill", "Solis.jobs.players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _services = TS.import(script, TS.getModule(script, "@rbxts", "services"))
local Players = _services.Players
local Workspace = _services.Workspace
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.players.kill"))() end)

newModule("spectate", "LocalScript", "Solis.jobs.players.spectate", "Solis.jobs.players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Workspace = TS.import(script, TS.getModule(script, "@rbxts", "services")).Workspace
local getSelectedPlayer = TS.import(script, script.Parent.Parent, "helpers", "get-selected-player").getSelectedPlayer
local _job_store = TS.import(script, script.Parent.Parent, "helpers", "job-store")
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.players.spectate"))() end)

newModule("teleport", "LocalScript", "Solis.jobs.players.teleport", "Solis.jobs.players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
local getSelectedPlayer = TS.import(script, script.Parent.Parent, "helpers", "get-selected-player").getSelectedPlayer
local _job_store = TS.import(script, script.Parent.Parent, "helpers", "job-store")
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.players.teleport"))() end)

newModule("server", "LocalScript", "Solis.jobs.server", "Solis.jobs", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local _services = TS.import(script, TS.getModule(script, "@rbxts", "services"))
local HttpService = _services.HttpService
local Players = _services.Players
local TeleportService = _services.TeleportService
local SOLIS_LOADER_URL = TS.import(script, script.Parent.Parent, "constants").SOLIS_LOADER_URL
...
function queueExecution()
	local code = 'loadstring(game:HttpGetAsync("' .. (SOLIS_LOADER_URL .. '"))()')
	local _result = syn
	if _result ~= nil then
...
main():catch(function(err)
 ...
 end, newEnv("Solis.jobs.server"))() end)

newModule("main", "LocalScript", "Solis.main", "Solis", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.include.RuntimeLib)
local Make = TS.import(script, TS.getModule(script, "@rbxts", "make"))
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local Provider = TS.import(script, TS.getModule(script, "@rbxts", "roact-rodux-hooked").out).Provider
...
local main = TS.async(function()
	if getgenv and getgenv()._SOLIS_IS_LOADED ~= nil then
		error("Solis is already loaded!")
	end
	...
	if getgenv then
		getgenv()._SOLIS_IS_LOADED = true
	end
end)
main():catch(function(err)
	warn("Solis failed to load: " .. tostring(err))
end)
 end, newEnv("Solis.main"))() end)

newInstance("store", "Folder", "Solis.store", "Solis")

newInstance("actions", "Folder", "Solis.store.actions", "Solis.store")

newModule("dashboard.action", "ModuleScript", "Solis.store.actions.dashboard.action", "Solis.store.actions", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.store.actions.dashboard.action"))() end)

newModule("jobs.action", "ModuleScript", "Solis.store.actions.jobs.action", "Solis.store.actions", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Rodux = TS.import(script, TS.getModule(script, "@rbxts", "rodux").src)
...
return {
 ...
 end, newEnv("Solis.store.actions.jobs.action"))() end)

newModule("options.action", "ModuleScript", "Solis.store.actions.options.action", "Solis.store.actions", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Rodux = TS.import(script, TS.getModule(script, "@rbxts", "rodux").src)
...
return {
 ...
 end, newEnv("Solis.store.actions.options.action"))() end)

newInstance("models", "Folder", "Solis.store.models", "Solis.store")

newModule("dashboard.model", "ModuleScript", "Solis.store.models.dashboard.model", "Solis.store.models", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local DashboardPage
do
	local _inverse = {}
	...
	DashboardPage.ScriptSearch = "scriptSearch"
	_inverse.scriptSearch = "ScriptSearch"
...
local PAGE_TO_ICON = {
	...
	[DashboardPage.ScriptSearch] = "",
	[DashboardPage.Options] = "rbxassetid://8992031056",
}
local PAGE_TO_TEXT_ICON = {
	[DashboardPage.ScriptSearch] = "S",
}
return {
	...
	PAGE_TO_TEXT_ICON = PAGE_TO_TEXT_ICON,
}
 end, newEnv("Solis.store.models.dashboard.model"))() end)

newModule("jobs.model", "ModuleScript", "Solis.store.models.jobs.model", "Solis.store.models", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
 end, newEnv("Solis.store.models.jobs.model"))() end)

newModule("options.model", "ModuleScript", "Solis.store.models.options.model", "Solis.store.models", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
 end, newEnv("Solis.store.models.options.model"))() end)

newModule("persistent-state", "ModuleScript", "Solis.store.persistent-state", "Solis.store", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local _services = TS.import(script, TS.getModule(script, "@rbxts", "services"))
local HttpService = _services.HttpService
local Players = _services.Players
...
if makefolder and not isfolder("_solis") then
	makefolder("_solis")
end
...
local function persistentState(name, selector, defaultValue)
	local _exitType, _returns = TS.try(function()
		local serializedState = read("_solis/" .. (name .. ".json"))
		if serializedState == nil then
			write("_solis/" .. (name .. ".json"), HttpService:JSONEncode(defaultValue))
...
autosave = TS.async(function(name, selector)
	...
	local function save()
		...
		write("_solis/" .. (name .. ".json"), HttpService:JSONEncode(state))
	end
...
return {
 ...
 end, newEnv("Solis.store.persistent-state"))() end)

newInstance("reducers", "Folder", "Solis.store.reducers", "Solis.store")

newModule("dashboard.reducer", "ModuleScript", "Solis.store.reducers.dashboard.reducer", "Solis.store.reducers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Rodux = TS.import(script, TS.getModule(script, "@rbxts", "rodux").src)
...
return {
 ...
 end, newEnv("Solis.store.reducers.dashboard.reducer"))() end)

newModule("jobs.reducer", "ModuleScript", "Solis.store.reducers.jobs.reducer", "Solis.store.reducers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Rodux = TS.import(script, TS.getModule(script, "@rbxts", "rodux").src)
local initialState = {
	flight = {
...
return {
 ...
 end, newEnv("Solis.store.reducers.jobs.reducer"))() end)

newModule("options.reducer", "ModuleScript", "Solis.store.reducers.options.reducer", "Solis.store.reducers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Rodux = TS.import(script, TS.getModule(script, "@rbxts", "rodux").src)
...
return {
 ...
 end, newEnv("Solis.store.reducers.options.reducer"))() end)

newModule("store", "ModuleScript", "Solis.store.store", "Solis.store", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Rodux = TS.import(script, TS.getModule(script, "@rbxts", "rodux").src)
...
return {
 ...
 end, newEnv("Solis.store.store"))() end)

newModule("themes", "ModuleScript", "Solis.themes", "Solis", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.include.RuntimeLib)
...
local solisTheme = TS.import(script, script, "solis-theme").solisTheme
local sorbet = TS.import(script, script, "sorbet").sorbet
local themes = { solisTheme, sorbet, darkTheme, lightTheme, frostedGlass, obsidian, highContrast }
...
return {
 ...
 end, newEnv("Solis.themes"))() end)

newModule("dark-theme", "ModuleScript", "Solis.themes.dark-theme", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local hex = TS.import(script, script.Parent.Parent, "utils", "color3").hex
local darkTheme = {
	name = "Dark theme",
	preview = {
		...
		accent = {
			color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFD24A")), ColorSequenceKeypoint.new(0.5, hex("#F2570C")), ColorSequenceKeypoint.new(1, hex("#C8400E")) }),
			rotation = 25,
		},
	},
	navbar = {
		...
		transparency = 0,
		accentGradient = {
			color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFE08A")), ColorSequenceKeypoint.new(0.25, hex("#FFC21E")), ColorSequenceKeypoint.new(0.5, hex("#FF9500")), ColorSequenceKeypoint.new(0.75, hex("#F2570C")), ColorSequenceKeypoint.new(1, hex("#C8400E")) }),
		},
	...
	home = {
		...
		profile = {
			...
			highlight = {
				flight = hex("#FFC21E"),
				walkSpeed = hex("#FF7A00"),
				jumpHeight = hex("#FFD86B"),
				refresh = hex("#FF9F1C"),
				ghost = hex("#F2570C"),
				godmode = hex("#FFB300"),
				freecam = hex("#FF6A00"),
		...
		server = {
			...
			acrylic = false,
			foreground = hex("#ffffff"),
			background = hex("#F2570C"),
			transparency = 0,
			dropshadow = hex("#F2570C"),
			dropshadowTransparency = 0.3,
			rejoinButton = {
				outlined = true,
				foreground = hex("#ffffff"),
	...
	apps = {
		players = {
			...
			avatar = {
				background = hex("#1B1C20"),
				gradient = {
					color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFD24A")), ColorSequenceKeypoint.new(1, hex("#C8400E")) }),
					rotation = 25,
				},
				transparency = 0,
			},
...
return {
 ...
 end, newEnv("Solis.themes.dark-theme"))() end)

newModule("frosted-glass", "ModuleScript", "Solis.themes.frosted-glass", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local darkTheme = TS.import(script, script.Parent, "dark-theme").darkTheme
local hex = TS.import(script, script.Parent.Parent, "utils", "color3").hex
local accent = hex("#FF8A00")
local accentSequence = ColorSequence.new(hex("#FF8A00"))
local view = {
	acrylic = true,
	outlined = true,
	foreground = hex("#ffffff"),
...
return {
 ...
 end, newEnv("Solis.themes.frosted-glass"))() end)

newModule("high-contrast", "ModuleScript", "Solis.themes.high-contrast", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local darkTheme = TS.import(script, script.Parent, "dark-theme").darkTheme
local hex = TS.import(script, script.Parent.Parent, "utils", "color3").hex
local _object = {}
...
_object.preview = {
	...
	accent = {
		color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFC21E")), ColorSequenceKeypoint.new(0.5, hex("#FF8A00")), ColorSequenceKeypoint.new(1, hex("#C8400E")) }),
		rotation = 25,
	},
}
local _left = "navbar"
...
return {
 ...
 end, newEnv("Solis.themes.high-contrast"))() end)

newModule("light-theme", "ModuleScript", "Solis.themes.light-theme", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local darkTheme = TS.import(script, script.Parent, "dark-theme").darkTheme
local hex = TS.import(script, script.Parent.Parent, "utils", "color3").hex
local _object = {}
...
_object.preview = {
	...
	accent = {
		color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFD24A")), ColorSequenceKeypoint.new(0.5, hex("#FF9500")), ColorSequenceKeypoint.new(1, hex("#C8400E")) }),
		rotation = 25,
	},
}
local _left = "navbar"
...
_object_6.transparency = 0.9
_object_6.gradient = {
	color = ColorSequence.new(hex("#FF8A00")),
}
_object_5[_left_5] = _object_6
local _left_6 = "slider"
local _object_7 = {}
...
_object_9.background = hex("#F2570C")
_object_9.dropshadow = hex("#F2570C")
local _left_9 = "rejoinButton"
local _object_10 = {}
for _k, _v in pairs(darkTheme.home.server.rejoinButton) do
	_object_10[_k] = _v
...
_object_10.background = hex("#F2570C")
...
_object_11.background = hex("#F2570C")
...
return {
 ...
 end, newEnv("Solis.themes.light-theme"))() end)

newModule("obsidian", "ModuleScript", "Solis.themes.obsidian", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local darkTheme = TS.import(script, script.Parent, "dark-theme").darkTheme
local hex = TS.import(script, script.Parent.Parent, "utils", "color3").hex
local accent = hex("#FF8A00")
...
return {
 ...
 end, newEnv("Solis.themes.obsidian"))() end)

newModule("solis-theme", "ModuleScript", "Solis.themes.solis-theme", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local hex = TS.import(script, script.Parent.Parent, "utils", "color3").hex
local SUN_RAMP = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFD24A")), ColorSequenceKeypoint.new(0.35, hex("#FF9500")), ColorSequenceKeypoint.new(0.7, hex("#F2570C")), ColorSequenceKeypoint.new(1, hex("#C8400E")) })
local solisTheme = {
	name = "Solis",
	preview = {
		foreground = {
		...
		background = {
			color = ColorSequence.new(hex("#1C120A")),
		},
		accent = {
			color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFD24A")), ColorSequenceKeypoint.new(0.5, hex("#FF7A00")), ColorSequenceKeypoint.new(1, hex("#C8400E")) }),
			rotation = 25,
		},
	},
	navbar = {
		...
		acrylic = false,
		foreground = hex("#ffffff"),
		background = hex("#1C120A"),
		transparency = 0,
		accentGradient = {
			color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FFE08A")), ColorSequenceKeypoint.new(0.25, hex("#FFC21E")), ColorSequenceKeypoint.new(0.5, hex("#FF9500")), ColorSequenceKeypoint.new(0.75, hex("#F2570C")), ColorSequenceKeypoint.new(1, hex("#C8400E")) }),
		},
		dropshadow = hex("#1C120A"),
		dropshadowTransparency = 0.3,
		glowTransparency = 0,
	},
	clock = {
	...
	apps = {
		players = {
			...
			avatar = {
				background = hex("#140C06"),
				gradient = {
					color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#FF9500")), ColorSequenceKeypoint.new(1, hex("#F2570C")) }),
					rotation = 25,
				},
				transparency = 0,
			},
...
return {
	solisTheme = solisTheme,
}
 end, newEnv("Solis.themes.solis-theme"))() end)

newModule("sorbet", "ModuleScript", "Solis.themes.sorbet", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local darkTheme = TS.import(script, script.Parent, "dark-theme").darkTheme
local hex = TS.import(script, script.Parent.Parent, "utils", "color3").hex
local redAccent = hex("#FF8A00")
local blueAccent = hex("#C8400E")
local mixedAccent = hex("#F2570C")
...
return {
 ...
 end, newEnv("Solis.themes.sorbet"))() end)

newModule("theme.interface", "ModuleScript", "Solis.themes.theme.interface", "Solis.themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
 end, newEnv("Solis.themes.theme.interface"))() end)

newInstance("utils", "Folder", "Solis.utils", "Solis")

newModule("array-util", "ModuleScript", "Solis.utils.array-util", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.utils.array-util"))() end)

newModule("binding-util", "ModuleScript", "Solis.utils.binding-util", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.utils.binding-util"))() end)

newModule("color3", "ModuleScript", "Solis.utils.color3", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.utils.color3"))() end)

newModule("debug", "ModuleScript", "Solis.utils.debug", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.utils.debug"))() end)

newModule("http", "ModuleScript", "Solis.utils.http", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
...
return {
 ...
 end, newEnv("Solis.utils.http"))() end)

newModule("number-util", "ModuleScript", "Solis.utils.number-util", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.utils.number-util"))() end)

newModule("timeout", "ModuleScript", "Solis.utils.timeout", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local RunService = TS.import(script, TS.getModule(script, "@rbxts", "services")).RunService
local Timeout
do
...
return {
 ...
 end, newEnv("Solis.utils.timeout"))() end)

newModule("udim2", "ModuleScript", "Solis.utils.udim2", "Solis.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.utils.udim2"))() end)

newInstance("views", "Folder", "Solis.views", "Solis")

newModule("Clock", "ModuleScript", "Solis.views.Clock", "Solis.views", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Clock").default
return exports
 end, newEnv("Solis.views.Clock"))() end)

newModule("Clock", "ModuleScript", "Solis.views.Clock.Clock", "Solis.views.Clock", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
local function Clock()
	...
	_attributes.Position = useSpring(isOpen and UDim2.new(0, 0, 0, 0) or UDim2.new(0, 0, 0, -(48 + 56 + 20)), {})
	_attributes.AnchorPoint = Vector2.new(0, 0)
	_attributes.BackgroundTransparency = 1
	local _children = {
		Roact.createElement(Glow, {
...
return {
 ...
 end, newEnv("Solis.views.Clock.Clock"))() end)

newModule("Dashboard", "ModuleScript", "Solis.views.Dashboard", "Solis.views", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Dashboard").default
return exports
 end, newEnv("Solis.views.Dashboard"))() end)

newModule("Dashboard", "ModuleScript", "Solis.views.Dashboard.Dashboard", "Solis.views.Dashboard", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Dashboard.Dashboard"))() end)

newModule("Dashboard.story", "ModuleScript", "Solis.views.Dashboard.Dashboard.story", "Solis.views.Dashboard", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local Provider = TS.import(script, TS.getModule(script, "@rbxts", "roact-rodux-hooked").out).Provider
local DashboardPage = TS.import(script, script.Parent.Parent.Parent, "store", "models", "dashboard.model").DashboardPage
...
return function(target)
 ...
 end, newEnv("Solis.views.Dashboard.Dashboard.story"))() end)

newModule("Hint", "ModuleScript", "Solis.views.Hint", "Solis.views", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Hint").default
return exports
 end, newEnv("Solis.views.Hint"))() end)

newModule("Hint", "ModuleScript", "Solis.views.Hint.Hint", "Solis.views.Hint", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
local function Hint()
	...
	return Roact.createElement("TextLabel", {
		...
		Position = useSpring(isHintVisible and UDim2.new(0.5, 0, 1, 0) or UDim2.new(0.5, 0, 1, 48), {}),
	}, {
...
return {
 ...
 end, newEnv("Solis.views.Hint.Hint"))() end)

newModule("Navbar", "ModuleScript", "Solis.views.Navbar", "Solis.views", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Navbar").default
return exports
 end, newEnv("Solis.views.Navbar"))() end)

newModule("Navbar", "ModuleScript", "Solis.views.Navbar.Navbar", "Solis.views.Navbar", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Acrylic = TS.import(script, script.Parent.Parent.Parent, "components", "Acrylic").default
...
local PAGE_COUNT = _dashboard_model.PAGE_COUNT
...
local NAVBAR_SIZE = px(100 * PAGE_COUNT, 56)
local Underglow
local function Navbar()
	...
	local alpha = useSpring(PAGE_TO_INDEX[page] / PAGE_COUNT, {
		frequency = 3.9,
		dampingRatio = 0.76,
	})
	local _attributes = {
		Size = NAVBAR_SIZE,
		Position = useSpring(isOpen and UDim2.new(0.5, 0, 0, 0) or UDim2.new(0.5, 0, 0, -(48 + 56 + 20)), {}),
	...
	local _children = {
		...
		Roact.createElement(Underglow, {
			...
			position = alpha:map(function(a)
				return a + 0.5 / PAGE_COUNT
			end),
			sequenceColor = alpha:map(function(a)
				return getColorInSequence(theme.accentGradient.color, a + 0.5 / PAGE_COUNT)
			end),
		}),
		Roact.createElement(Fill, {
			color = theme.background,
		...
		Roact.createElement(Canvas, {
			...
			Roact.createElement("Frame", {
				Size = NAVBAR_SIZE,
				Position = alpha:map(function(a)
					return scale(-PAGE_COUNT * (math.round(a * 1000) / 1000), 0)
				end),
	...
	_children[_length + 4] = Roact.createElement(NavbarTab, {
		page = DashboardPage.ScriptSearch,
	})
...
return {
 ...
 end, newEnv("Solis.views.Navbar.Navbar"))() end)

newModule("Navbar.story", "ModuleScript", "Solis.views.Navbar.Navbar.story", "Solis.views.Navbar", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local Provider = TS.import(script, TS.getModule(script, "@rbxts", "roact-rodux-hooked").out).Provider
local DashboardPage = TS.import(script, script.Parent.Parent.Parent, "store", "models", "dashboard.model").DashboardPage
...
return function(target)
 ...
 end, newEnv("Solis.views.Navbar.Navbar.story"))() end)

newModule("NavbarTab", "ModuleScript", "Solis.views.Navbar.NavbarTab", "Solis.views.Navbar", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
local PAGE_TO_INDEX = _dashboard_model.PAGE_TO_INDEX
local PAGE_TO_TEXT_ICON = _dashboard_model.PAGE_TO_TEXT_ICON
local _udim2 = TS.import(script, script.Parent.Parent.Parent, "utils", "udim2")
local px = _udim2.px
local scale = _udim2.scale
...
local function NavbarTab(_param)
	...
	local setHovered = _binding[2]
	local iconTransparency = useSpring(isActive and 0 or (isHovered and 0.5 or 0.75), {})
	return Roact.createElement("TextButton", {
		Text = "",
		AutoButtonColor = false,
		Active = not isActive,
		Size = TAB_SIZE,
		Position = scale(PAGE_TO_INDEX[page] / PAGE_COUNT, 0),
		BackgroundTransparency = 1,
		[Roact.Event.Activated] = function()
		...
		PAGE_TO_TEXT_ICON[page] ~= nil and (Roact.createElement("TextLabel", {
			Text = PAGE_TO_TEXT_ICON[page],
			Font = "GothamBlack",
			TextSize = 24,
			TextColor3 = theme.foreground,
...
return {
 ...
 end, newEnv("Solis.views.Navbar.NavbarTab"))() end)

newModule("Pages", "ModuleScript", "Solis.views.Pages", "Solis.views", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Pages").default
return exports
 end, newEnv("Solis.views.Pages"))() end)

newModule("Apps", "ModuleScript", "Solis.views.Pages.Apps", "Solis.views.Pages", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Apps").default
return exports
 end, newEnv("Solis.views.Pages.Apps"))() end)

newModule("Apps", "ModuleScript", "Solis.views.Pages.Apps.Apps", "Solis.views.Pages.Apps", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.views.Pages.Apps.Apps"))() end)

newModule("Players", "ModuleScript", "Solis.views.Pages.Apps.Players", "Solis.views.Pages.Apps", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Players").default
return exports
 end, newEnv("Solis.views.Pages.Apps.Players"))() end)

newModule("Actions", "ModuleScript", "Solis.views.Pages.Apps.Players.Actions", "Solis.views.Pages.Apps.Players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.views.Pages.Apps.Players.Actions"))() end)

newModule("Avatar", "ModuleScript", "Solis.views.Pages.Apps.Players.Avatar", "Solis.views.Pages.Apps.Players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
return {
 ...
 end, newEnv("Solis.views.Pages.Apps.Players.Avatar"))() end)

newModule("Players", "ModuleScript", "Solis.views.Pages.Apps.Players.Players", "Solis.views.Pages.Apps.Players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Apps.Players.Players"))() end)

newModule("Selection", "ModuleScript", "Solis.views.Pages.Apps.Players.Selection", "Solis.views.Pages.Apps.Players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Apps.Players.Selection"))() end)

newModule("Username", "ModuleScript", "Solis.views.Pages.Apps.Players.Username", "Solis.views.Pages.Apps.Players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
return {
 ...
 end, newEnv("Solis.views.Pages.Apps.Players.Username"))() end)

newModule("Home", "ModuleScript", "Solis.views.Pages.Home", "Solis.views.Pages", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Home").default
return exports
 end, newEnv("Solis.views.Pages.Home"))() end)

newModule("FriendActivity", "ModuleScript", "Solis.views.Pages.Home.FriendActivity", "Solis.views.Pages.Home", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "FriendActivity").default
return exports
 end, newEnv("Solis.views.Pages.Home.FriendActivity"))() end)

newModule("FriendActivity", "ModuleScript", "Solis.views.Pages.Home.FriendActivity.FriendActivity", "Solis.views.Pages.Home.FriendActivity", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.FriendActivity.FriendActivity"))() end)

newModule("FriendItem", "ModuleScript", "Solis.views.Pages.Home.FriendActivity.FriendItem", "Solis.views.Pages.Home.FriendActivity", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.FriendActivity.FriendItem"))() end)

newModule("GameItem", "ModuleScript", "Solis.views.Pages.Home.FriendActivity.GameItem", "Solis.views.Pages.Home.FriendActivity", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.FriendActivity.GameItem"))() end)

newModule("Home", "ModuleScript", "Solis.views.Pages.Home.Home", "Solis.views.Pages.Home", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local pure = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).pure
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, "components", "Canvas").default
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Home"))() end)

newModule("Profile", "ModuleScript", "Solis.views.Pages.Home.Profile", "Solis.views.Pages.Home", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Profile").default
return exports
 end, newEnv("Solis.views.Pages.Home.Profile"))() end)

newModule("Actions", "ModuleScript", "Solis.views.Pages.Home.Profile.Actions", "Solis.views.Pages.Home.Profile", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local ActionButton = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "components", "ActionButton").default
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Profile.Actions"))() end)

newModule("Avatar", "ModuleScript", "Solis.views.Pages.Home.Profile.Avatar", "Solis.views.Pages.Home.Profile", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
local Border = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "components", "Border").default
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "components", "Canvas").default
local useRotation = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "hooks", "common", "use-rotation").useRotation
local useTheme = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "hooks", "use-theme").useTheme
local hex = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "utils", "color3").hex
local px = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "utils", "udim2").px
...
local function Avatar()
	local theme = useTheme("home").profile
	local shineRotation = useRotation(90)
	return Roact.createElement(Canvas, {
		anchor = Vector2.new(0.5, 0),
		size = px(186, 186),
		position = UDim2.new(0.5, 0, 0, 24),
		...
		Roact.createElement(Border, {
			...
			Roact.createElement("UIGradient", {
				Color = ColorSequence.new(hex("#ffffff")),
				Transparency = NumberSequence.new({ NumberSequenceKeypoint.new(0, 0.15), NumberSequenceKeypoint.new(0.3, 0.85), NumberSequenceKeypoint.new(1, 1) }),
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Profile.Avatar"))() end)

newModule("Info", "ModuleScript", "Solis.views.Pages.Home.Profile.Info", "Solis.views.Pages.Home.Profile", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Profile.Info"))() end)

newModule("Profile", "ModuleScript", "Solis.views.Pages.Home.Profile.Profile", "Solis.views.Pages.Home.Profile", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "components", "Canvas").default
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Profile.Profile"))() end)

newModule("Sliders", "ModuleScript", "Solis.views.Pages.Home.Profile.Sliders", "Solis.views.Pages.Home.Profile", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Profile.Sliders"))() end)

newModule("Username", "ModuleScript", "Solis.views.Pages.Home.Profile.Username", "Solis.views.Pages.Home.Profile", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Profile.Username"))() end)

newModule("Server", "ModuleScript", "Solis.views.Pages.Home.Server", "Solis.views.Pages.Home", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Server").default
return exports
 end, newEnv("Solis.views.Pages.Home.Server"))() end)

newModule("Server", "ModuleScript", "Solis.views.Pages.Home.Server.Server", "Solis.views.Pages.Home.Server", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
local function Server()
	...
	return Roact.createElement(Card, {
		...
		theme = theme,
		size = px(326, 184),
		position = UDim2.new(1, -326, 0, 184),
	}, {
		Roact.createElement("TextLabel", {
			Text = "Server",
			Font = "GothamBlack",
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Server.Server"))() end)

newModule("ServerAction", "ModuleScript", "Solis.views.Pages.Home.Server.ServerAction", "Solis.views.Pages.Home.Server", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Server.ServerAction"))() end)

newModule("StatusLabel", "ModuleScript", "Solis.views.Pages.Home.Server.StatusLabel", "Solis.views.Pages.Home.Server", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Server.StatusLabel"))() end)

newModule("Title", "ModuleScript", "Solis.views.Pages.Home.Title", "Solis.views.Pages.Home", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, "components", "Canvas").default
...
local function Title()
	...
	return Roact.createElement(Card, {
		...
		Roact.createElement(ParallaxImage, {
			image = "rbxassetid://105894109382235",
			imageSize = Vector2.new(1024, 1024),
...
return {
 ...
 end, newEnv("Solis.views.Pages.Home.Title"))() end)

newModule("Options", "ModuleScript", "Solis.views.Pages.Options", "Solis.views.Pages", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Options").default
return exports
 end, newEnv("Solis.views.Pages.Options"))() end)

newModule("Config", "ModuleScript", "Solis.views.Pages.Options.Config", "Solis.views.Pages.Options", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Config").default
return exports
 end, newEnv("Solis.views.Pages.Options.Config"))() end)

newModule("Config", "ModuleScript", "Solis.views.Pages.Options.Config.Config", "Solis.views.Pages.Options.Config", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "components", "Canvas").default
...
return {
 ...
 end, newEnv("Solis.views.Pages.Options.Config.Config"))() end)

newModule("ConfigItem", "ModuleScript", "Solis.views.Pages.Options.Config.ConfigItem", "Solis.views.Pages.Options.Config", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local pure = _roact_hooked.pure
...
return {
 ...
 end, newEnv("Solis.views.Pages.Options.Config.ConfigItem"))() end)

newModule("Options", "ModuleScript", "Solis.views.Pages.Options.Options", "Solis.views.Pages.Options", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local pure = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).pure
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, "components", "Canvas").default
...
return {
 ...
 end, newEnv("Solis.views.Pages.Options.Options"))() end)

newModule("Shortcuts", "ModuleScript", "Solis.views.Pages.Options.Shortcuts", "Solis.views.Pages.Options", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Shortcuts").default
return exports
 end, newEnv("Solis.views.Pages.Options.Shortcuts"))() end)

newModule("ShortcutItem", "ModuleScript", "Solis.views.Pages.Options.Shortcuts.ShortcutItem", "Solis.views.Pages.Options.Shortcuts", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local pure = _roact_hooked.pure
...
return {
 ...
 end, newEnv("Solis.views.Pages.Options.Shortcuts.ShortcutItem"))() end)

newModule("Shortcuts", "ModuleScript", "Solis.views.Pages.Options.Shortcuts.Shortcuts", "Solis.views.Pages.Options.Shortcuts", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Options.Shortcuts.Shortcuts"))() end)

newModule("Themes", "ModuleScript", "Solis.views.Pages.Options.Themes", "Solis.views.Pages.Options", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Themes").default
return exports
 end, newEnv("Solis.views.Pages.Options.Themes"))() end)

newModule("ThemeItem", "ModuleScript", "Solis.views.Pages.Options.Themes.ThemeItem", "Solis.views.Pages.Options.Themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Options.Themes.ThemeItem"))() end)

newModule("Themes", "ModuleScript", "Solis.views.Pages.Options.Themes.Themes", "Solis.views.Pages.Options.Themes", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Options.Themes.Themes"))() end)

newModule("Pages", "ModuleScript", "Solis.views.Pages.Pages", "Solis.views.Pages", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local useDelayedUpdate = TS.import(script, script.Parent.Parent.Parent, "hooks", "common", "use-delayed-update").useDelayedUpdate
...
local ScriptSearch = TS.import(script, script.Parent, "ScriptSearch").default
local function Pages()
	...
	_length = #_children
	_children.scriptSearch = Roact.createFragment({
		scriptSearch = Roact.createElement(ScriptSearch),
	})
...
return {
 ...
 end, newEnv("Solis.views.Pages.Pages"))() end)

newModule("ScriptSearch", "ModuleScript", "Solis.views.Pages.ScriptSearch", "Solis.views.Pages", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "ScriptSearch").default
return exports
 end, newEnv("Solis.views.Pages.ScriptSearch"))() end)

newModule("ResultCard", "ModuleScript", "Solis.views.Pages.ScriptSearch.ResultCard", "Solis.views.Pages.ScriptSearch", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
local useEffect = _roact_hooked.useEffect
local useState = _roact_hooked.useState
local useAppDispatch = TS.import(script, script.Parent.Parent.Parent.Parent, "hooks", "common", "rodux-hooks").useAppDispatch
local useSpring = TS.import(script, script.Parent.Parent.Parent.Parent, "hooks", "common", "use-spring").useSpring
local useTheme = TS.import(script, script.Parent.Parent.Parent.Parent, "hooks", "use-theme").useTheme
...
local px = _udim2.px
local scale = _udim2.scale
local _scriptblox = TS.import(script, script.Parent, "scriptblox")
local loadImage = _scriptblox.loadImage
local runScript = _scriptblox.runScript
local function escapeRichText(text)
	return (string.gsub((string.gsub((string.gsub(text, "&", "&amp;")), "<", "&lt;")), ">", "&gt;"))
end
local function ResultCard(_param)
	...
	local isHovered = _binding[1]
	local setHovered = _binding[2]
	local _binding_1 = useState(nil)
	local image = _binding_1[1]
	local setImage = _binding_1[2]
	useEffect(function()
		local _condition = item.image
		if _condition == nil then
			local _result = item.game
			if _result ~= nil then
				_result = _result.imageUrl
			end
			_condition = _result
		end
		local _exp = loadImage(_condition)
		local _arg0 = function(asset)
			return setImage(asset)
		end
		_exp:andThen(_arg0):catch(function() end)
	end, {})
	local statusTag = item.isPatched == true and "PATCHED" or (item.key == true and "KEY" or nil)
	local statusColor = item.isPatched == true and hex("#C8400E") or hex("#FFC21E")
	local _attributes = {
		Text = "",
		AutoButtonColor = false,
		LayoutOrder = index,
		...
		[Roact.Event.Activated] = function()
			runScript(item)
			dispatch(setHint("Running <font face='GothamBlack'>" .. (escapeRichText(item.title) .. "</font>")))
		end,
		[Roact.Event.MouseEnter] = function()
			setHovered(true)
			local _exp = "Run <font face='GothamBlack'>" .. (escapeRichText(item.title) .. "</font>")
			local _result = item.game
			if _result ~= nil then
				_result = _result.name
			end
			dispatch(setHint(_exp .. (_result ~= nil and " (" .. (escapeRichText(item.game.name) .. ")") or "")))
		end,
		[Roact.Event.MouseLeave] = function()
			setHovered(false)
			dispatch(clearHint())
	...
	local _attributes_1 = {
		AnchorPoint = Vector2.new(0.5, 0.5),
		Position = scale(0.5, 0.5),
		Size = useSpring(isHovered and UDim2.new(1, -8, 1, -8) or UDim2.new(1, -24, 1, -24), {
			frequency = 2,
		}),
		BackgroundTransparency = 1,
	}
	local _children_1 = {
		...
		Roact.createElement("UIStroke", {
			Color = useSpring(isHovered and hex("#FF8A00") or hex("#ffffff"), {}),
			Thickness = 3,
			Transparency = useSpring(isHovered and 0 or 0.8, {}),
		}),
	}
	local _length_1 = #_children_1
	local _attributes_2 = {}
	local _condition = image
	if _condition == nil then
		_condition = ""
	end
	_attributes_2.Image = _condition
	_attributes_2.Size = scale(1, 1)
	_attributes_2.ScaleType = "Crop"
	_attributes_2.ZIndex = 0
	_attributes_2.BackgroundColor3 = theme.themeButton.background
	_attributes_2.BackgroundTransparency = theme.themeButton.backgroundTransparency
	_children_1.thumbnail = Roact.createElement("ImageLabel", _attributes_2, {
		Roact.createElement("UICorner", {
			CornerRadius = UDim.new(0, 16),
		}),
	})
	_children_1.shade = Roact.createElement("Frame", {
	...
	local _condition_1 = _result ~= nil
	if _condition_1 then
		_condition_1 = (Roact.createFragment({
	...
	if _condition_1 then
		if _condition_1.elements ~= nil or _condition_1.props ~= nil and _condition_1.component ~= nil then
			_children_1[_length_1 + 1] = _condition_1
		else
			for _k, _v in ipairs(_condition_1) do
				_children_1[_length_1 + _k] = _v
			end
		end
	end
	_length_1 = #_children_1
	local _child = item.views ~= nil and (Roact.createFragment({
		views = Roact.createElement("TextLabel", {
			Text = tostring(item.views) .. " views",
			Font = "GothamSemibold",
			TextSize = 13,
			TextColor3 = hex("#ffffff"),
			...
			Position = UDim2.new(0, 20, 1, -16 - 16),
			ZIndex = 3,
			BackgroundTransparency = 1,
		}),
	}))
	...
	_length_1 = #_children_1
	local _child_1 = statusTag ~= nil and (Roact.createFragment({
		statusTag = Roact.createElement("TextLabel", {
			Text = statusTag,
			Font = "GothamBlack",
			TextSize = 13,
			...
			TextYAlignment = "Bottom",
			Size = UDim2.new(0.5, -20, 0, 16),
			Position = UDim2.new(0.5, 0, 1, -16 - 16),
			ZIndex = 3,
			BackgroundTransparency = 1,
		}),
	}))
	...
	_length_1 = #_children_1
	_children_1.shine = Roact.createElement("Frame", {
		Size = scale(1, 1),
		BackgroundColor3 = hex("#ffffff"),
		BackgroundTransparency = useSpring(isHovered and 0 or 1, {
			dampingRatio = 3,
			frequency = 2,
		}),
		BorderSizePixel = 0,
	...
	_children.body = Roact.createElement("Frame", _attributes_1, _children_1)
	return Roact.createElement("TextButton", _attributes, _children)
end
local default = hooked(ResultCard)
return {
	default = default,
}
 end, newEnv("Solis.views.Pages.ScriptSearch.ResultCard"))() end)

newModule("ScriptSearch", "ModuleScript", "Solis.views.Pages.ScriptSearch.ScriptSearch", "Solis.views.Pages.ScriptSearch", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
local px = _udim2.px
local scale = _udim2.scale
local ResultCard = TS.import(script, script.Parent, "ResultCard").default
local searchScripts = TS.import(script, script.Parent, "scriptblox").searchScripts
local COLUMNS = 3
local CELL_HEIGHT = 304
local CELL_GAP = 24
local SEARCH_BAR_HEIGHT = 44
local GRID_TOP = SEARCH_BAR_HEIGHT + 24
local function ScriptSearch()
	local theme = useTheme("options").themes
	local scaleFactor = useScale()
	local isOpen = useIsPageOpen(DashboardPage.ScriptSearch)
	local _binding = useState({})
	local scripts = _binding[1]
	local setScripts = _binding[2]
	local _binding_1 = useState("idle")
	local status = _binding_1[1]
	local setStatus = _binding_1[2]
	local requestId = useMutable(0)
	local function search(query)
		requestId.current += 1
		local id = requestId.current
		setStatus("loading")
		local _exp = searchScripts(query)
		local _arg0 = function(results)
			if requestId.current == id then
				setScripts(results)
				setStatus("done")
			end
		end
	...
	useEffect(function()
		if isOpen and status == "idle" then
			search("")
		end
	end, { isOpen })
	local rows = math.ceil(#scripts / COLUMNS)
	local canvasHeight = rows > 0 and rows * CELL_HEIGHT + (rows - 1) * CELL_GAP or 0
	local statusMessage = status == "loading" and "Searching ScriptBlox..." or (status == "error" and "ScriptBlox request failed. Your executor must support HTTP requests." or (status == "done" and #scripts == 0 and "No scripts found. Try a different search." or nil))
	local _attributes = {
		position = scale(0, 1),
		anchor = Vector2.new(0, 1),
	}
	...
	local _length = #_children
	local _attributes_1 = {
		position = useSpring(isOpen and scale(0, 0) or UDim2.new(0, 0, 1.5, 0), {
			frequency = 2.2,
			dampingRatio = 0.75,
		}),
	}
	local _children_1 = {
		searchBar = Roact.createElement("Frame", {
			Size = px(560, SEARCH_BAR_HEIGHT),
			Position = UDim2.new(0.5, 0, 0, 0),
			AnchorPoint = Vector2.new(0.5, 0),
			BackgroundColor3 = theme.themeButton.background,
			BackgroundTransparency = theme.themeButton.backgroundTransparency,
		}, {
			Roact.createElement("UICorner", {
				CornerRadius = UDim.new(0, 8),
			}),
			...
			Roact.createElement("TextBox", {
				Text = "",
				PlaceholderText = "Search scripts on ScriptBlox...",
				PlaceholderColor3 = hex("#ffffff"),
				TextColor3 = hex("#ffffff"),
	...
	local _length_1 = #_children_1
	local _attributes_2 = {
		Visible = statusMessage ~= nil,
	}
	local _condition = statusMessage
	if _condition == nil then
		_condition = ""
	end
	_attributes_2.Text = _condition
	_attributes_2.Font = "GothamSemibold"
	_attributes_2.TextSize = 14
	_attributes_2.TextColor3 = theme.foreground
	_attributes_2.TextTransparency = 0.4
	_attributes_2.TextXAlignment = "Center"
	_attributes_2.Size = UDim2.new(1, 0, 0, 20)
	_attributes_2.Position = UDim2.new(0, 0, 0, SEARCH_BAR_HEIGHT + 2)
	_attributes_2.ZIndex = 2
	_attributes_2.BackgroundTransparency = 1
	_children_1.status = Roact.createElement("TextLabel", _attributes_2)
	local _attributes_3 = {
		Size = UDim2.new(1, 0, 1, -GRID_TOP),
		Position = px(0, GRID_TOP),
		CanvasSize = px(0, canvasHeight),
		ScrollBarThickness = 4,
		ScrollBarImageColor3 = hex("#FF8A00"),
		ScrollingDirection = "Y",
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
	}
	local _children_2 = {
		Roact.createElement("UIGridLayout", {
			CellSize = UDim2.new(1 / COLUMNS, -math.ceil((CELL_GAP * (COLUMNS - 1)) / COLUMNS), 0, CELL_HEIGHT),
			CellPadding = px(CELL_GAP, CELL_GAP),
			SortOrder = "LayoutOrder",
		}),
	}
	local _length_2 = #_children_2
	for _k, _v in pairs(arrayToMap(scripts, function(item, index)
		return { item._id, Roact.createElement(ResultCard, {
			item = item,
			index = index,
		}) }
	end)) do
	...
	_children_1.grid = Roact.createElement("ScrollingFrame", _attributes_3, _children_2)
	_children[_length + 1] = Roact.createElement(Canvas, _attributes_1, _children_1)
	return Roact.createElement(Canvas, _attributes, _children)
end
local default = hooked(ScriptSearch)
return {
	default = default,
}
 end, newEnv("Solis.views.Pages.ScriptSearch.ScriptSearch"))() end)

newModule("scriptblox", "ModuleScript", "Solis.views.Pages.ScriptSearch.scriptblox", "Solis.views.Pages.ScriptSearch", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local HttpService = TS.import(script, TS.getModule(script, "@rbxts", "services")).HttpService
local http = TS.import(script, script.Parent.Parent.Parent.Parent, "utils", "http")
local BASE_URL = "https://scriptblox.com"
local CACHE_DIR = "_solis/cache"
local searchScripts = TS.async(function(query, page)
	if page == nil then
		page = 1
	end
	local url = #query > 0 and BASE_URL .. ("/api/script/search?q=" .. (HttpService:UrlEncode(query) .. ("&page=" .. tostring(page)))) or BASE_URL .. ("/api/script/fetch?page=" .. tostring(page))
	local body = TS.await(http.get(url))
	local response = HttpService:JSONDecode(body)
	local _result = response.result
	if _result ~= nil then
		_result = _result.scripts
	end
	local _condition = _result
	if _condition == nil then
		_condition = {}
...
local function runScript(item)
	local source = item.script
	if source == nil or #source == 0 then
		warn('[Solis] "' .. (item.title .. '" has no runnable script'))
		return nil
	end
	task.defer(function()
		local fn, err = loadstring(source)
		if not fn then
			warn('[Solis] Failed to load "' .. (item.title .. ('": ' .. tostring(err))))
			return nil
		end
		local success, result = pcall(fn)
		if not success then
			warn('[Solis] "' .. (item.title .. ('" errored: ' .. tostring(result))))
		end
	end)
end
local imageCache = {}
local loadImage = TS.async(function(path)
	if path == nil or #path == 0 then
		return nil
	end
	local url = (string.find(path, "^http")) ~= nil and path or BASE_URL .. path
	...
	if not writefile or (not isfolder or (not makefolder or getcustomasset == nil)) then
		-- ▼ Map.set ▼
	...
	local _exitType, _returns = TS.try(function()
		local data = TS.await(http.get(url))
		local fileName = string.sub((string.gsub(url, "[^%w%.]", "_")), -64)
		local success, asset = pcall(function()
			if not isfolder(CACHE_DIR) then
				makefolder(CACHE_DIR)
			end
			writefile(CACHE_DIR .. ("/" .. fileName), data)
			return getcustomasset(CACHE_DIR .. ("/" .. fileName))
		end)
		if not success or (asset == nil or #asset == 0) then
			-- ▼ Map.set ▼
			imageCache[url] = false
			-- ▲ Map.set ▲
...
return {
 ...
 end, newEnv("Solis.views.Pages.ScriptSearch.scriptblox"))() end)

newModule("Scripts", "ModuleScript", "Solis.views.Pages.Scripts", "Solis.views.Pages", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
exports.default = TS.import(script, script, "Scripts").default
return exports
 end, newEnv("Solis.views.Pages.Scripts"))() end)

newModule("Content", "ModuleScript", "Solis.views.Pages.Scripts.Content", "Solis.views.Pages.Scripts", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).hooked
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, "components", "Canvas").default
...
return {
 ...
 end, newEnv("Solis.views.Pages.Scripts.Content"))() end)

newModule("ScriptCard", "ModuleScript", "Solis.views.Pages.Scripts.ScriptCard", "Solis.views.Pages.Scripts", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local hooked = _roact_hooked.hooked
...
return {
 ...
 end, newEnv("Solis.views.Pages.Scripts.ScriptCard"))() end)

newModule("Scripts", "ModuleScript", "Solis.views.Pages.Scripts.Scripts", "Solis.views.Pages.Scripts", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
local pure = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out).pure
local Canvas = TS.import(script, script.Parent.Parent.Parent.Parent, "components", "Canvas").default
...
return {
 ...
 end, newEnv("Solis.views.Pages.Scripts.Scripts"))() end)

newModule("constants", "ModuleScript", "Solis.views.Pages.Scripts.constants", "Solis.views.Pages.Scripts", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.views.Pages.Scripts.constants"))() end)

newInstance("include", "Folder", "Solis.include", "Solis")

newModule("Promise", "ModuleScript", "Solis.include.Promise", "Solis.include", function () return setfenv(function() --[[
...
return Promise
 end, newEnv("Solis.include.Promise"))() end)

newModule("RuntimeLib", "ModuleScript", "Solis.include.RuntimeLib", "Solis.include", function () return setfenv(function() local Promise = require(script.Parent.Promise)
...
return TS
 end, newEnv("Solis.include.RuntimeLib"))() end)

newInstance("node_modules", "Folder", "Solis.include.node_modules", "Solis.include")

newInstance("compiler-types", "Folder", "Solis.include.node_modules.compiler-types", "Solis.include.node_modules")

newInstance("types", "Folder", "Solis.include.node_modules.compiler-types.types", "Solis.include.node_modules.compiler-types")

newInstance("exploit-types", "Folder", "Solis.include.node_modules.exploit-types", "Solis.include.node_modules")

newInstance("types", "Folder", "Solis.include.node_modules.exploit-types.types", "Solis.include.node_modules.exploit-types")

newInstance("flipper", "Folder", "Solis.include.node_modules.flipper", "Solis.include.node_modules")

newModule("src", "ModuleScript", "Solis.include.node_modules.flipper.src", "Solis.include.node_modules.flipper", function () return setfenv(function() local Flipper = {
...
return Flipper end, newEnv("Solis.include.node_modules.flipper.src"))() end)

newModule("BaseMotor", "ModuleScript", "Solis.include.node_modules.flipper.src.BaseMotor", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local RunService = game:GetService("RunService")
...
return BaseMotor
 end, newEnv("Solis.include.node_modules.flipper.src.BaseMotor"))() end)

newModule("GroupMotor", "ModuleScript", "Solis.include.node_modules.flipper.src.GroupMotor", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local BaseMotor = require(script.Parent.BaseMotor)
...
return GroupMotor
 end, newEnv("Solis.include.node_modules.flipper.src.GroupMotor"))() end)

newModule("Instant", "ModuleScript", "Solis.include.node_modules.flipper.src.Instant", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local Instant = {}
...
return Instant end, newEnv("Solis.include.node_modules.flipper.src.Instant"))() end)

newModule("Linear", "ModuleScript", "Solis.include.node_modules.flipper.src.Linear", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local Linear = {}
...
return Linear end, newEnv("Solis.include.node_modules.flipper.src.Linear"))() end)

newModule("Signal", "ModuleScript", "Solis.include.node_modules.flipper.src.Signal", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local Connection = {}
...
return Signal end, newEnv("Solis.include.node_modules.flipper.src.Signal"))() end)

newModule("SingleMotor", "ModuleScript", "Solis.include.node_modules.flipper.src.SingleMotor", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local BaseMotor = require(script.Parent.BaseMotor)
...
return SingleMotor
 end, newEnv("Solis.include.node_modules.flipper.src.SingleMotor"))() end)

newModule("Spring", "ModuleScript", "Solis.include.node_modules.flipper.src.Spring", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local VELOCITY_THRESHOLD = 0.001
...
return Spring end, newEnv("Solis.include.node_modules.flipper.src.Spring"))() end)

newModule("isMotor", "ModuleScript", "Solis.include.node_modules.flipper.src.isMotor", "Solis.include.node_modules.flipper.src", function () return setfenv(function() local function isMotor(value)
...
return isMotor end, newEnv("Solis.include.node_modules.flipper.src.isMotor"))() end)

newInstance("typings", "Folder", "Solis.include.node_modules.flipper.typings", "Solis.include.node_modules.flipper")

newModule("make", "ModuleScript", "Solis.include.node_modules.make", "Solis.include.node_modules", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
--[[
	*
...
return Make
 end, newEnv("Solis.include.node_modules.make"))() end)

newInstance("node_modules", "Folder", "Solis.include.node_modules.make.node_modules", "Solis.include.node_modules.make")

newInstance("@rbxts", "Folder", "Solis.include.node_modules.make.node_modules.@rbxts", "Solis.include.node_modules.make.node_modules")

newInstance("compiler-types", "Folder", "Solis.include.node_modules.make.node_modules.@rbxts.compiler-types", "Solis.include.node_modules.make.node_modules.@rbxts")

newInstance("types", "Folder", "Solis.include.node_modules.make.node_modules.@rbxts.compiler-types.types", "Solis.include.node_modules.make.node_modules.@rbxts.compiler-types")

newModule("object-utils", "ModuleScript", "Solis.include.node_modules.object-utils", "Solis.include.node_modules", function () return setfenv(function() local HttpService = game:GetService("HttpService")
...
return Object
 end, newEnv("Solis.include.node_modules.object-utils"))() end)

newInstance("roact", "Folder", "Solis.include.node_modules.roact", "Solis.include.node_modules")

newModule("src", "ModuleScript", "Solis.include.node_modules.roact.src", "Solis.include.node_modules.roact", function () return setfenv(function() --[[
...
return Roact end, newEnv("Solis.include.node_modules.roact.src"))() end)

newModule("Binding", "ModuleScript", "Solis.include.node_modules.roact.src.Binding", "Solis.include.node_modules.roact.src", function () return setfenv(function() local createSignal = require(script.Parent.createSignal)
...
return BindingInternalApi end, newEnv("Solis.include.node_modules.roact.src.Binding"))() end)

newModule("Component", "ModuleScript", "Solis.include.node_modules.roact.src.Component", "Solis.include.node_modules.roact.src", function () return setfenv(function() local assign = require(script.Parent.assign)
...
return Component end, newEnv("Solis.include.node_modules.roact.src.Component"))() end)

newModule("ComponentLifecyclePhase", "ModuleScript", "Solis.include.node_modules.roact.src.ComponentLifecyclePhase", "Solis.include.node_modules.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)
...
return ComponentLifecyclePhase end, newEnv("Solis.include.node_modules.roact.src.ComponentLifecyclePhase"))() end)

newModule("Config", "ModuleScript", "Solis.include.node_modules.roact.src.Config", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return Config end, newEnv("Solis.include.node_modules.roact.src.Config"))() end)

newModule("ElementKind", "ModuleScript", "Solis.include.node_modules.roact.src.ElementKind", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return ElementKind end, newEnv("Solis.include.node_modules.roact.src.ElementKind"))() end)

newModule("ElementUtils", "ModuleScript", "Solis.include.node_modules.roact.src.ElementUtils", "Solis.include.node_modules.roact.src", function () return setfenv(function() local Type = require(script.Parent.Type)
local Symbol = require(script.Parent.Symbol)
...
return ElementUtils end, newEnv("Solis.include.node_modules.roact.src.ElementUtils"))() end)

newModule("GlobalConfig", "ModuleScript", "Solis.include.node_modules.roact.src.GlobalConfig", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
	Exposes a single instance of a configuration as Roact's GlobalConfig.
]]

local Config = require(script.Parent.Config)

return Config.new() end, newEnv("Solis.include.node_modules.roact.src.GlobalConfig"))() end)

newModule("Logging", "ModuleScript", "Solis.include.node_modules.roact.src.Logging", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return Logging end, newEnv("Solis.include.node_modules.roact.src.Logging"))() end)

newModule("None", "ModuleScript", "Solis.include.node_modules.roact.src.None", "Solis.include.node_modules.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)

-- Marker used to specify that the value is nothing, because nil cannot be
-- stored in tables.
local None = Symbol.named("None")

return None end, newEnv("Solis.include.node_modules.roact.src.None"))() end)

newModule("NoopRenderer", "ModuleScript", "Solis.include.node_modules.roact.src.NoopRenderer", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return NoopRenderer end, newEnv("Solis.include.node_modules.roact.src.NoopRenderer"))() end)

newModule("Portal", "ModuleScript", "Solis.include.node_modules.roact.src.Portal", "Solis.include.node_modules.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)

local Portal = Symbol.named("Portal")

return Portal end, newEnv("Solis.include.node_modules.roact.src.Portal"))() end)

newInstance("PropMarkers", "Folder", "Solis.include.node_modules.roact.src.PropMarkers", "Solis.include.node_modules.roact.src")

newModule("Change", "ModuleScript", "Solis.include.node_modules.roact.src.PropMarkers.Change", "Solis.include.node_modules.roact.src.PropMarkers", function () return setfenv(function() --[[
...
return Change
 end, newEnv("Solis.include.node_modules.roact.src.PropMarkers.Change"))() end)

newModule("Children", "ModuleScript", "Solis.include.node_modules.roact.src.PropMarkers.Children", "Solis.include.node_modules.roact.src.PropMarkers", function () return setfenv(function() local Symbol = require(script.Parent.Parent.Symbol)

local Children = Symbol.named("Children")

return Children end, newEnv("Solis.include.node_modules.roact.src.PropMarkers.Children"))() end)

newModule("Event", "ModuleScript", "Solis.include.node_modules.roact.src.PropMarkers.Event", "Solis.include.node_modules.roact.src.PropMarkers", function () return setfenv(function() --[[
...
return Event
 end, newEnv("Solis.include.node_modules.roact.src.PropMarkers.Event"))() end)

newModule("Ref", "ModuleScript", "Solis.include.node_modules.roact.src.PropMarkers.Ref", "Solis.include.node_modules.roact.src.PropMarkers", function () return setfenv(function() local Symbol = require(script.Parent.Parent.Symbol)

local Ref = Symbol.named("Ref")

return Ref end, newEnv("Solis.include.node_modules.roact.src.PropMarkers.Ref"))() end)

newModule("PureComponent", "ModuleScript", "Solis.include.node_modules.roact.src.PureComponent", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return PureComponent end, newEnv("Solis.include.node_modules.roact.src.PureComponent"))() end)

newModule("RobloxRenderer", "ModuleScript", "Solis.include.node_modules.roact.src.RobloxRenderer", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return RobloxRenderer
 end, newEnv("Solis.include.node_modules.roact.src.RobloxRenderer"))() end)

newModule("SingleEventManager", "ModuleScript", "Solis.include.node_modules.roact.src.SingleEventManager", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return SingleEventManager end, newEnv("Solis.include.node_modules.roact.src.SingleEventManager"))() end)

newModule("Symbol", "ModuleScript", "Solis.include.node_modules.roact.src.Symbol", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return Symbol end, newEnv("Solis.include.node_modules.roact.src.Symbol"))() end)

newModule("Type", "ModuleScript", "Solis.include.node_modules.roact.src.Type", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return Type end, newEnv("Solis.include.node_modules.roact.src.Type"))() end)

newModule("assertDeepEqual", "ModuleScript", "Solis.include.node_modules.roact.src.assertDeepEqual", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return assertDeepEqual end, newEnv("Solis.include.node_modules.roact.src.assertDeepEqual"))() end)

newModule("assign", "ModuleScript", "Solis.include.node_modules.roact.src.assign", "Solis.include.node_modules.roact.src", function () return setfenv(function() local None = require(script.Parent.None)
...
return assign end, newEnv("Solis.include.node_modules.roact.src.assign"))() end)

newModule("createContext", "ModuleScript", "Solis.include.node_modules.roact.src.createContext", "Solis.include.node_modules.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)
...
return createContext
 end, newEnv("Solis.include.node_modules.roact.src.createContext"))() end)

newModule("createElement", "ModuleScript", "Solis.include.node_modules.roact.src.createElement", "Solis.include.node_modules.roact.src", function () return setfenv(function() local Children = require(script.Parent.PropMarkers.Children)
local ElementKind = require(script.Parent.ElementKind)
local Logging = require(script.Parent.Logging)
local Type = require(script.Parent.Type)
...
return createElement end, newEnv("Solis.include.node_modules.roact.src.createElement"))() end)

newModule("createFragment", "ModuleScript", "Solis.include.node_modules.roact.src.createFragment", "Solis.include.node_modules.roact.src", function () return setfenv(function() local ElementKind = require(script.Parent.ElementKind)
local Type = require(script.Parent.Type)
...
return createFragment end, newEnv("Solis.include.node_modules.roact.src.createFragment"))() end)

newModule("createReconciler", "ModuleScript", "Solis.include.node_modules.roact.src.createReconciler", "Solis.include.node_modules.roact.src", function () return setfenv(function() local Type = require(script.Parent.Type)
local ElementKind = require(script.Parent.ElementKind)
...
return createReconciler
 end, newEnv("Solis.include.node_modules.roact.src.createReconciler"))() end)

newModule("createReconcilerCompat", "ModuleScript", "Solis.include.node_modules.roact.src.createReconcilerCompat", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return createReconcilerCompat end, newEnv("Solis.include.node_modules.roact.src.createReconcilerCompat"))() end)

newModule("createRef", "ModuleScript", "Solis.include.node_modules.roact.src.createRef", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return createRef end, newEnv("Solis.include.node_modules.roact.src.createRef"))() end)

newModule("createSignal", "ModuleScript", "Solis.include.node_modules.roact.src.createSignal", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return createSignal
 end, newEnv("Solis.include.node_modules.roact.src.createSignal"))() end)

newModule("createSpy", "ModuleScript", "Solis.include.node_modules.roact.src.createSpy", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return createSpy end, newEnv("Solis.include.node_modules.roact.src.createSpy"))() end)

newModule("forwardRef", "ModuleScript", "Solis.include.node_modules.roact.src.forwardRef", "Solis.include.node_modules.roact.src", function () return setfenv(function() local assign = require(script.Parent.assign)
...
return forwardRef end, newEnv("Solis.include.node_modules.roact.src.forwardRef"))() end)

newModule("getDefaultInstanceProperty", "ModuleScript", "Solis.include.node_modules.roact.src.getDefaultInstanceProperty", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return getDefaultInstanceProperty end, newEnv("Solis.include.node_modules.roact.src.getDefaultInstanceProperty"))() end)

newModule("internalAssert", "ModuleScript", "Solis.include.node_modules.roact.src.internalAssert", "Solis.include.node_modules.roact.src", function () return setfenv(function() local function internalAssert(condition, message)
	if not condition then
		error(message .. " (This is probably a bug in Roact!)", 3)
	end
end

return internalAssert end, newEnv("Solis.include.node_modules.roact.src.internalAssert"))() end)

newModule("invalidSetStateMessages", "ModuleScript", "Solis.include.node_modules.roact.src.invalidSetStateMessages", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return invalidSetStateMessages end, newEnv("Solis.include.node_modules.roact.src.invalidSetStateMessages"))() end)

newModule("oneChild", "ModuleScript", "Solis.include.node_modules.roact.src.oneChild", "Solis.include.node_modules.roact.src", function () return setfenv(function() --[[
...
return oneChild end, newEnv("Solis.include.node_modules.roact.src.oneChild"))() end)

newModule("strict", "ModuleScript", "Solis.include.node_modules.roact.src.strict", "Solis.include.node_modules.roact.src", function () return setfenv(function() local function strict(t, name)
...
return strict end, newEnv("Solis.include.node_modules.roact.src.strict"))() end)

newInstance("roact-hooked", "Folder", "Solis.include.node_modules.roact-hooked", "Solis.include.node_modules")

newModule("out", "ModuleScript", "Solis.include.node_modules.roact-hooked.out", "Solis.include.node_modules.roact-hooked", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local exports = {}
...
exports.pure = pure
return exports
 end, newEnv("Solis.include.node_modules.roact-hooked.out"))() end)

newModule("hooks", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks", "Solis.include.node_modules.roact-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local exports = {}
...
return exports
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks"))() end)

newModule("use-binding", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-binding", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local createBinding = TS.import(script, TS.getModule(script, "@rbxts", "roact").src).createBinding
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-binding"))() end)

newModule("use-callback", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-callback", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-callback"))() end)

newModule("use-context", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-context", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
--[[
	*
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-context"))() end)

newModule("use-effect", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-effect", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-effect"))() end)

newModule("use-memo", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-memo", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local areDepsEqual = TS.import(script, script.Parent.Parent, "utils", "are-deps-equal").areDepsEqual
local memoizedHook = TS.import(script, script.Parent.Parent, "utils", "memoized-hook").memoizedHook
--[[
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-memo"))() end)

newModule("use-mutable", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-mutable", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local memoizedHook = TS.import(script, script.Parent.Parent, "utils", "memoized-hook").memoizedHook
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-mutable"))() end)

newModule("use-reducer", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-reducer", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local _memoized_hook = TS.import(script, script.Parent.Parent, "utils", "memoized-hook")
local memoizedHook = _memoized_hook.memoizedHook
local resolveCurrentComponent = _memoized_hook.resolveCurrentComponent
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-reducer"))() end)

newModule("use-ref", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-ref", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-ref"))() end)

newModule("use-state", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.hooks.use-state", "Solis.include.node_modules.roact-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.hooks.use-state"))() end)

newModule("types", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.types", "Solis.include.node_modules.roact-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
-- Roact
-- Reducers
-- Utility types
-- Hooks
return nil
 end, newEnv("Solis.include.node_modules.roact-hooked.out.types"))() end)

newInstance("utils", "Folder", "Solis.include.node_modules.roact-hooked.out.utils", "Solis.include.node_modules.roact-hooked.out")

newModule("are-deps-equal", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.utils.are-deps-equal", "Solis.include.node_modules.roact-hooked.out.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.utils.are-deps-equal"))() end)

newModule("memoized-hook", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.utils.memoized-hook", "Solis.include.node_modules.roact-hooked.out.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.utils.memoized-hook"))() end)

newModule("with-hooks", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.with-hooks", "Solis.include.node_modules.roact-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local exports = {}
local _with_hooks = TS.import(script, script, "with-hooks")
...
return exports
 end, newEnv("Solis.include.node_modules.roact-hooked.out.with-hooks"))() end)

newModule("component-with-hooks", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks", "Solis.include.node_modules.roact-hooked.out.with-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local _memoized_hook = TS.import(script, script.Parent.Parent, "utils", "memoized-hook")
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks"))() end)

newModule("with-hooks", "ModuleScript", "Solis.include.node_modules.roact-hooked.out.with-hooks.with-hooks", "Solis.include.node_modules.roact-hooked.out.with-hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-hooked.out.with-hooks.with-hooks"))() end)

newInstance("roact-rodux-hooked", "Folder", "Solis.include.node_modules.roact-rodux-hooked", "Solis.include.node_modules")

newModule("out", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out", "Solis.include.node_modules.roact-rodux-hooked", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
local exports = {}
...
return exports
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out"))() end)

newInstance("components", "Folder", "Solis.include.node_modules.roact-rodux-hooked.out.components", "Solis.include.node_modules.roact-rodux-hooked.out")

newModule("context", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out.components.context", "Solis.include.node_modules.roact-rodux-hooked.out.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out.components.context"))() end)

newModule("provider", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out.components.provider", "Solis.include.node_modules.roact-rodux-hooked.out.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out.components.provider"))() end)

newInstance("helpers", "Folder", "Solis.include.node_modules.roact-rodux-hooked.out.helpers", "Solis.include.node_modules.roact-rodux-hooked.out")

newModule("shallow-equal", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal", "Solis.include.node_modules.roact-rodux-hooked.out.helpers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal"))() end)

newInstance("hooks", "Folder", "Solis.include.node_modules.roact-rodux-hooked.out.hooks", "Solis.include.node_modules.roact-rodux-hooked.out")

newModule("use-dispatch", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch", "Solis.include.node_modules.roact-rodux-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch"))() end)

newModule("use-selector", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out.hooks.use-selector", "Solis.include.node_modules.roact-rodux-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
local _roact_hooked = TS.import(script, TS.getModule(script, "@rbxts", "roact-hooked").out)
local useEffect = _roact_hooked.useEffect
local useMutable = _roact_hooked.useMutable
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out.hooks.use-selector"))() end)

newModule("use-store", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out.hooks.use-store", "Solis.include.node_modules.roact-rodux-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
...
return {
 ...
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out.hooks.use-store"))() end)

newModule("types", "ModuleScript", "Solis.include.node_modules.roact-rodux-hooked.out.types", "Solis.include.node_modules.roact-rodux-hooked.out", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
--[[
	*
	* A Roact Context
]]
return nil
 end, newEnv("Solis.include.node_modules.roact-rodux-hooked.out.types"))() end)

newInstance("rodux", "Folder", "Solis.include.node_modules.rodux", "Solis.include.node_modules")

newModule("src", "ModuleScript", "Solis.include.node_modules.rodux.src", "Solis.include.node_modules.rodux", function () return setfenv(function() local Store = require(script.Store)
...
return {
 ...
 end, newEnv("Solis.include.node_modules.rodux.src"))() end)

newModule("NoYield", "ModuleScript", "Solis.include.node_modules.rodux.src.NoYield", "Solis.include.node_modules.rodux.src", function () return setfenv(function() --!nocheck
...
return NoYield
 end, newEnv("Solis.include.node_modules.rodux.src.NoYield"))() end)

newModule("Signal", "ModuleScript", "Solis.include.node_modules.rodux.src.Signal", "Solis.include.node_modules.rodux.src", function () return setfenv(function() --[[
...
return Signal end, newEnv("Solis.include.node_modules.rodux.src.Signal"))() end)

newModule("Store", "ModuleScript", "Solis.include.node_modules.rodux.src.Store", "Solis.include.node_modules.rodux.src", function () return setfenv(function() local RunService = game:GetService("RunService")
...
return Store
 end, newEnv("Solis.include.node_modules.rodux.src.Store"))() end)

newModule("combineReducers", "ModuleScript", "Solis.include.node_modules.rodux.src.combineReducers", "Solis.include.node_modules.rodux.src", function () return setfenv(function() --[[
...
return combineReducers
 end, newEnv("Solis.include.node_modules.rodux.src.combineReducers"))() end)

newModule("createReducer", "ModuleScript", "Solis.include.node_modules.rodux.src.createReducer", "Solis.include.node_modules.rodux.src", function () return setfenv(function() return function(initialState, handlers)
	return function(state, action)
		if state == nil then
			state = initialState
		end
 ...
 end, newEnv("Solis.include.node_modules.rodux.src.createReducer"))() end)

newModule("loggerMiddleware", "ModuleScript", "Solis.include.node_modules.rodux.src.loggerMiddleware", "Solis.include.node_modules.rodux.src", function () return setfenv(function() -- We want to be able to override outputFunction in tests, so the shape of this
...
return loggerMiddleware
 end, newEnv("Solis.include.node_modules.rodux.src.loggerMiddleware"))() end)

newModule("makeActionCreator", "ModuleScript", "Solis.include.node_modules.rodux.src.makeActionCreator", "Solis.include.node_modules.rodux.src", function () return setfenv(function() --[[
...
return makeActionCreator
 end, newEnv("Solis.include.node_modules.rodux.src.makeActionCreator"))() end)

newModule("prettyPrint", "ModuleScript", "Solis.include.node_modules.rodux.src.prettyPrint", "Solis.include.node_modules.rodux.src", function () return setfenv(function() local indent = "    "
...
return prettyPrint end, newEnv("Solis.include.node_modules.rodux.src.prettyPrint"))() end)

newModule("thunkMiddleware", "ModuleScript", "Solis.include.node_modules.rodux.src.thunkMiddleware", "Solis.include.node_modules.rodux.src", function () return setfenv(function() --[[
...
return thunkMiddleware
 end, newEnv("Solis.include.node_modules.rodux.src.thunkMiddleware"))() end)

newModule("services", "ModuleScript", "Solis.include.node_modules.services", "Solis.include.node_modules", function () return setfenv(function() return setmetatable({}, {
 ...
 end, newEnv("Solis.include.node_modules.services"))() end)

newInstance("types", "Folder", "Solis.include.node_modules.types", "Solis.include.node_modules")

newInstance("include", "Folder", "Solis.include.node_modules.types.include", "Solis.include.node_modules.types")

newInstance("generated", "Folder", "Solis.include.node_modules.types.include.generated", "Solis.include.node_modules.types.include")

init()

print("[CI 1.0.0] Solis run in " .. (os.clock() - START_TIME) * 1000 .. " ms")
